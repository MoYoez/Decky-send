...
function Content() {
    ...
    if (!pluginReady) {
        return SP_JSX.jsx(DFL.PanelSection, { children: "\u521D\u59CB\u5316\u4E2D..." });
    }
    ...
    return (SP_JSX.jsxs("div", { style: {
            ...
            backgroundColor: "var(--gpBackground-color, #1b1b1b)"
                        ...
                        marginBottom: '-10px'
                            ...
                            }, tabIndex: 0, role: "img", "aria-label": `QR码: ${serverStatus.url}`, onFocus: (e) => e.currentTarget.style.outline = '3px solid #1b73e8', onBlur: (e) => e.currentTarget.style.outline = 'none', onClick: (e) => e.preventDefault(), onKeyDown: (e) => {
                                ...
                                wordBreak: 'break-all'
                                    ...
                                    userSelect: 'text',
                                    transition: 'outline 0.2s ease'
                                }, tabIndex: 0, role: "text", "aria-label": "\u670D\u52A1\u5668URL\u5730\u5740", onFocus: (e) => e.currentTarget.style.outline = '3px solid #1b73e8', onBlur: (e) => e.currentTarget.style.outline = 'none', onClick: (e) => e.preventDefault(), onKeyDown: (e) => {
                                    // Prevent default keyboard actions that might interfere with navigation
                                    if (['Enter', 'Space'].includes(e.key)) {
                                        e.preventDefault();
                                    }
